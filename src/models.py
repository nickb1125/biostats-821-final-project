...
if (os.path.exists("train_class.pickle")) & (os.path.exists("best_playoff_model.pickle")):
    with open('train_class.pickle', 'rb') as handle:
        train_class = pickle.load(handle)
    with open('best_playoff_model.pickle', 'rb') as handle:
...
with open('train_class.pickle', 'wb') as handle:
...
with open('best_playoff_model.pickle', 'wb') as handle:
